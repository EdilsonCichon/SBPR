...
public class ControladoraInterfaces {
    ...
    public static void setarTitulo(int codInicio, JPCrud crud){
        ...
        switch (codInicio){
            ...
            case 1: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Produtores")); break;
            case 2: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Propriedades")); break;
            case 3: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Máquinas")); break;
            case 4: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Funcionários")); break;
            case 5: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Tipos de Serviços")); break;
            case 6: crud.setBorder(BorderFactory.createTitledBorder("Gerenciar Tipos de Máquinas")); break;
            default: break;   
        }
    }
}
