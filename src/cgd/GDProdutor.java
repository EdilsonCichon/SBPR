...
public class GDProdutor {
    ...
    public LinkedList<Produtor> filtrar(String colunaFiltro, String valorFiltro) {
        ...
        listaPropriedades.add( new Propriedade(10, "Fazenda 1", "Perto da estrada", null));
        listaPropriedades.add( new Propriedade(20, "Fazenda 2", "Longe da estrada", null));
        listaPropriedades.add( new Propriedade(30, "Fazenda 3", "Na da estrada", null));
